...
export const getAllPostList = async (boardType, page = 0, maxPage = 5) => {
    try {
...
export const getPostListResult = async (boardType, page = 1) => {
    const url = urlMap[boardType];
...
export const getPostDetails = async (boardType, resId) => {
    const url = urlMap[boardType];
